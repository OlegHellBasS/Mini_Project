fetch('https://jsonplaceholder.typicode.com/users')
    ...
    .then(value => {
        for (const {id,name} of value) {
            ...
            user__btn.onclick = (e) => location.href = `user-details.html?id=${id}`;

            user.append(user__text,user__btn);

            const users__row = document.body.querySelector('.users_row')
            users__row.appendChild(user);
        }
    })
